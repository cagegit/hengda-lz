<template>
    <div class="main-page-box">
        ...
        <div class="main-page-menu">
            <mt-tabbar>
                <mt-tab-item id="home" @click.native="checkPage('home',0)" :class="{'red-color':active==0}">
                ...
                <mt-tab-item id="message" @click.native="checkPage('message',1)" :class="{'red-color':active==1}"
                             class="msg-dot">
                    ...
                    <div class="mes-war"></div>
                    消息
                </mt-tab-item>
                <mt-tab-item id="user" @click.native="checkPage('user',2)" :class="{'red-color':active==2}">
