...
export const mutations = {
  ...
  [types.LOGIN](state, data) {
    ...
    state.industrialGroup = data.data.IndustrialGroup;

    console.log(state.userLoginInfo);
    console.log(state.userLoginInfo.name);

    localStorage.setItem('sessionId', data.data.JSESSIONID)
    state.sessionId = data.data.JSESSIONID
